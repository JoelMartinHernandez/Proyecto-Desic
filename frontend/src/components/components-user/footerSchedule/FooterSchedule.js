...
function FooterScheduleU() {
  ...
  return (
    <div className="bodyFooter">
        <div className='scheduleHour' onClick={()=>navigate(`/user/Line/${idLine}/schedule`)}>
        <img src={hour} alt="Horas" />
        <p>Horario</p>
        </div>
        <div className='scheduleBus' onClick={()=>navigate(`/user/Line/${idLine}/BusStop`)}>
...
export default FooterScheduleU